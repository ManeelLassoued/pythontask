...
# Given a string S
#  consisting of only lowercase and uppercase English letters and spaces,
# your task is to convert it into title case. In title case, the first
# letter of each word is capitalized while the rest are in lowercase,
# except for words that are entirely in uppercase (considered as
# acronyms), which should remain unchanged.
#
# Note:
